    ...
    <div className="min-h-screen bg-gradient-to-b from-green-50/50 to-white flex items-center justify-center p-4">
      ...
      <Card className="w-full max-w-md shadow-lg">
        ...
        <CardContent className="space-y-6">
          {/* Role Selection - 2x2 Grid for 4 roles */}
          <div className="space-y-3">
            <div className="bg-gray-100 rounded-lg p-1 grid grid-cols-2 gap-1">
              <button
                type="button"
              ...
              <button
                ...
                className={`py-2 px-4 rounded-md text-sm font-medium transition-colors ${selectedRole === 'GP'
                  ? 'bg-white text-gray-900 shadow-sm'
                  : 'text-gray-600 hover:text-gray-900'
                  }`}
              >
