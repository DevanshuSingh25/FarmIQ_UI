...
const roleDescriptions = {
  ...
  GP: 'Create & manage farmer profiles'
};
        ...
        <CardContent className="space-y-6">
          ...
          <div className="space-y-3">
            ...
            >
              ...
              <div
                className={`flex items-start space-x-3 border rounded-lg p-3 cursor-pointer transition-colors ${selectedRole === 'GP' ? 'border-green-500 bg-green-50' : 'border-gray-200'
                  }`}
                onClick={() => handleRoleChange('GP')}
              >
                <RadioGroupItem value="GP" id="GP" className="mt-1" />
                <div className="flex-1">
                  <Label htmlFor="GP" className="cursor-pointer font-medium">
                    Gram-Panchayat
                  </Label>
                  <p className="text-xs text-muted-foreground">
                    {roleDescriptions.GP}
