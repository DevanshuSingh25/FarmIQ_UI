      ...
      <div className="container mx-auto px-4 py-8 pt-24">
          ...
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-5xl font-bold flex items-center gap-4 mb-2">
                <span className="text-6xl">📡</span> Smart Tools
              </h1>
              <p className="text-2xl text-muted-foreground mt-2">
                Control your devices and view farm data
              </p>
            </div>

            {iotStatus && (
              <Badge variant={iotStatus.status === 'active' ? 'default' : 'secondary'} className="text-lg px-4 py-2">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          <TabsList className="grid w-full grid-cols-2 h-24 p-2 bg-muted/50">
            <TabsTrigger value="request" className="text-2xl h-full data-[state=active]:bg-white data-[state=active]:shadow-md">
              <span className="mr-3 text-3xl">📝</span> Request & Status
            </TabsTrigger>
            <TabsTrigger value="readings" className="text-2xl h-full data-[state=active]:bg-white data-[state=active]:shadow-md">
              <span className="mr-3 text-3xl">📊</span> Live Data
            </TabsTrigger>
          </TabsList>
