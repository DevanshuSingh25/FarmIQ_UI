        ...
        <div className="min-h-screen bg-[#F8F9FA] dark:bg-gray-900 font-sans text-gray-900 dark:text-gray-100">
                            ...
                            <Sheet>
                                ...
                                <SheetContent side="left" className="w-[300px] sm:w-[340px] p-6 bg-[#F8F9FA] dark:bg-gray-800">
                                    ...
                                    <div className="space-y-3">
                                        <button onClick={() => navigate('/grampanchayat/dashboard')} className="w-full flex items-center justify-between px-4 py-3 bg-[#1a5d1a] dark:bg-green-700 text-white rounded-full shadow-sm transition-all group">
            ...
            <main className="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
                    ...
                    {/* Schemes */}
                    <Card className="hover:shadow-lg transition-shadow cursor-pointer border-2 border-purple-100" onClick={() => navigate('/farmer/ngo-schemes')}>
                        <CardHeader>
                            <div className="flex items-center justify-between">
                    ...
                    {/* Weather */}
                    <Card className="hover:shadow-lg transition-shadow cursor-pointer border-2 border-blue-100" onClick={() => navigate('/farmer/weather')}>
                        <CardHeader>
                            <div className="flex items-center justify-between">
